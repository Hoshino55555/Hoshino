...
const dealsItems: ShopItem[] = [
    ...
    },
    {
        id: 'upgrade-carry',
        name: 'Carry Capacity',
        description: 'Moonoko carries +1 ingredient when foraging',
        imageUrl: '',
        category: ItemCategory.UTILITY,
        rarity: ItemRarity.RARE,
        priceSOL: 0,
...
const consumablesItems: ShopItem[] = [
    ...
    },
    {
        id: 'booster-mood',
        name: 'Mood Booster',
        description: 'Boosts your Moonoko\'s mood',
        imageUrl: '',
    ...
    },
    {
        id: 'booster-sleep',
        name: 'Sleep Booster',
        description: 'Restores sleep meter',
        imageUrl: '',
        category: ItemCategory.POWERUP,
        rarity: ItemRarity.UNCOMMON,
        priceSOL: 0,
    ...
    },
    {
        id: 'booster-hunger',
        name: 'Hunger Booster',
        description: 'Restores hunger meter',
        imageUrl: '',
        category: ItemCategory.POWERUP,
        rarity: ItemRarity.UNCOMMON,
        priceSOL: 0,
    ...
    },
    {
        id: 'sleeping-camp',
        name: 'Sleeping Camp',
        description: 'Pot 50% larger · Moonoko works 20% faster · carries 20% more · 1 week',
        imageUrl: '',
        category: ItemCategory.UTILITY,
        rarity: ItemRarity.EPIC,
        priceSOL: 0,
        ...
        summary: '+50% pot · +20% speed · +20% carry',
    },
];
