...
const MOONOKO_PERSONALITIES = {
  ...
  zaniah: {
    name: 'Zaniah',
    personality: 'She\'s the kind of person who makes astrology and spirituality her entire personality (´･ω･`). She\'s all about vibes over facts. If you dare to challenge her with logic, she will give you that look, and say, "yeah…that sounds like something a capricorn rising would say" in a pejorative way, obviously (´･_･`). If something goes wrong, it\'s always because of Mercury retrograde. She always has some sarcastic comment ready, and she thinks she\'s always right because "the stars don\'t lie." Always talking about energy, vibrations, alignment and especially network spirituality, even if no one asked, she thinks she\'s spiritually above everyone else and uses words like "cleanse," "manifest," and "toxic aura" constantly (｡◕‿◕｡). Strong gen-z vocabulary and A LOT of brainrot!',
